...
import BatchArtistAlbumDownload from '@/views/BatchArtistAlbumDownload.vue';
...
const routes = [
    ...
    { path: '/batchArtistAlbumDownload', name: 'BatchArtistAlbumDownload', component: BatchArtistAlbumDownload },
];
